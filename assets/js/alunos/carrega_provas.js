...
async function carregar() {
    ...
    if (rs1["status"] && rs2["status"]) {
        ...
        res1.forEach((e) => {
            if (r3.includes(e.cod) && ativo.includes(e.disciplina)) {
                try {
                    $("#ficha").append(
                        `<button type="button" 
                        class="btn btn-primary confg" 
                        data-toggle="modal" 
                        data-target="#tarja${e.disciplina}">${
                            disc[e.disciplina]
                        }</button>`
                    );
                    $("#features-sec").append(
                                ...
                                <div class="modal-body">
                                    <form method="post" id="exerciciosalunos${e.disciplina}">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-primary" id="respondendo" data-toggle="${e.disciplina}">Enviar</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
